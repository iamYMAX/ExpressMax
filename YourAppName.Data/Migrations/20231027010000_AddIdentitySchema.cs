...
namespace YourAppName.Data.Migrations
{
    ...
    public partial class AddIdentitySchema : Migration
    {
        ...
        {
            // Potentially alter Users table if IdentityUser<int> adds columns not already there
            // For example, IdentityUser adds NormalizedUserName, NormalizedEmail, EmailConfirmed, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount
            // Our User model already had UserName, Email, PhoneNumber. PasswordHash is also standard.
            // Id is primary key.
            // The custom 'Role' string property on our User class is not part of IdentityUser and will remain as a custom column.
            ...
            // Assuming 'Email' column already exists from InitialCreate, if not, it would be added.
            ...
            migrationBuilder.AddColumn<string>(
                ...
                table: "Users",
                type: "TEXT",
                maxLength: 256, // Typical length for normalized fields
                nullable: true);
            ...
            // Create Roles table (we named it "Roles")
            ...
            // Create UserRoles table (junction table for Users and Roles)
            migrationBuilder.CreateTable(
                name: "UserRoles",
                columns: table => new
                {
            ...
            // Add Indexes for Identity tables
            ...
            // Indexes for Users table (NormalizedUserName, NormalizedEmail)
            // These are typically added by IdentityUser configuration
             migrationBuilder.CreateIndex(
                  name: "UserNameIndex", // Default name for this index by Identity
                  table: "Users",
                  column: "NormalizedUserName",
                  unique: true);

             migrationBuilder.CreateIndex(
                  name: "EmailIndex", // Default name for this index by Identity
                  table: "Users",
